                    ...
                    <div class="card bg-pattern">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center w-100 m-auto">
                                ...
                                <p class="login-title-desc mb-4">Enter your email address and password to access your account.</p>
                            </div>
                                ...
                                <div class="mb-3">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        @if (Route::has('password.request'))
                                            <a href="{{ route('password.request') }}" class="forgot-link mb-1">Forgot Password?</a>
                                        @endif
                                    </div>
